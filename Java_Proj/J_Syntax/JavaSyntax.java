...
public class JavaSyntax {
	...
	public static void main(String[] args){
		...
		*/
		...
		// System.out.printf("%d %c %10s %b %d %.2f", zeroOrone, forChar, name, bool, forInt, forFloat); 
		...
		// System.out.println(name.contains("e")); // can also create a loop and check ascii code value
		...
		// System.out.println( Math.pow(3,3) *2 /3);       // 9.0 float beaccuase of math power
		...
		// 	System.out.printf("This will run even though k = %d & num3 = %d. And the condition is k > num3", k, num3);
		//    	k++;
	 	// } while(k <= num3);
		...
		// for(int x2 : array){
		// 	System.out.printf("%d \t", x2); // %d for int, %f for deci, %c, %s, Date&time:%t %tH %tS;
		// }
		...
		// for(i = 1;i < 5; i++){ // This only incre when loop ends;
		// 	System.out.println(i);
		// 	i++;
		// 	System.out.println(i);
		// }
		...
		// System.out.println("Index of 1st \"up the\" is:"+   str2.indexOf("up the")); //lastIndexOf();
		...
		// short numExam = 2;
		// System.out.println(str1 + numExam); // Ans is not an erro, as str and num can get concatinated;
		// System.out.println("This is carrage return \\r removed the text before it. for e.g:");
		// System.out.println("This is carrage return \r removed the text before it. and then we have (+++  ppp\b  +++) back space there were suppose to be 3 (P's)"); 
		

		// //Escape Sequence; print special char to strings;
		// // \t, \n = \r, \",  \b backspace (it deletes), \* Hexcode ...;

		// //split() [Returns a array], trim() whitespace remove, replace(t,p)..., indexOf()... ;
		
		// //======================================== Spliting strings ====================================================== 
		
		// String str3 = "The man ran up the hill.";
		// String[] strArry = str3.split( "\s+", 5); //regex: regular expresion, self Explainatory.
